...
variable "env" {
  description = " current environment in scope."
  type        = string
}
...
#OCI Container Registry parameters
variable "container_registry_compartment_id" {
  type        = string
  description = "compartment to create  service " 
  default     = ""
}
